...
import card1Stats from 'src/components/hiveworld/Card1Stats.vue'
import card1Balances from 'src/components/hiveworld/Card1Balances.vue'
import card1AccountDetails from 'src/components/hiveworld/Card1AccountDetails.vue'
import card1WitnessDetails from 'src/components/hiveworld/Card1WitnessDetails.vue'
import card1Delegations from 'src/components/hiveworld/Card1Delegations.vue'
import card1Followers from 'src/components/hiveworld/Card1Followers.vue'
import card1Mentions from 'src/components/hiveworld/Card1Mentions.vue'
import card1Orders from 'src/components/hiveworld/Card1Orders.vue'
import card1MarketInfo from 'src/components/hiveworld/Card1MarketInfo.vue'
import card1SystemInfo from 'src/components/hiveworld/Card1SystemInfo.vue'
import card1Settings from 'src/components/hiveworld/Card1Settings.vue'
import card2AccountOperations from 'src/components/hiveworld/Card2AccountOperations.vue'
import card3Posts from 'src/components/hiveworld/Card3Posts.vue'
import card5Tools from 'src/components/hiveworld/Card5ToolsTabs.vue'
export default {
  name: 'Home',
  data () {
    return {
